...
import { Feature, FeatureCollection, Geometry, GeoJsonObject, MultiLineString } from "geojson";
import { GeoPermissibleObjects, GeoProjection } from "d3-geo";
import type { Topology } from "topojson-specification";
export type ProjectionName = "geoAlbers" | "geoAlbersUsa" | "geoAzimuthalEqualArea" | "geoAzimuthalEquidistant" | "geoConicConformal" | "geoConicEqualArea" | "geoConicEquidistant" | "geoEqualEarth" | "geoEquirectangular" | "geoGnomonic" | "geoMercator" | "geoNaturalEarth1" | "geoOrthographic" | "geoStereographic" | "geoTransverseMercator";
...
export interface GraticuleProps extends Omit<SVGProps<SVGPathElement>, "children"> {
    fill?: string;
    stroke?: string;
    step?: [number, number];
    className?: string;
}
export interface SphereProps extends Omit<SVGProps<SVGPathElement>, "children"> {
    id?: string;
    fill?: string;
    stroke?: string;
    className?: string;
}
export interface LineProps extends Omit<SVGProps<SVGPathElement>, "children" | "from" | "to"> {
    from?: [number, number];
    to?: [number, number];
...
export interface AnnotationProps extends Omit<SVGProps<SVGGElement>, "children"> {
