  ...
  const fetchReporte = async () => {
    try {
      ...
      const res = await fetch(
        `http://localhost:5000/api/reporte-proveedores?fecha_inicio=${fechaInicio}&fecha_fin=${fechaFin}`,
      );
          ...
          >
            <div>
              <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                <Truck className="text-indigo-600" size={22} /> Dashboard de
                Analítica de Proveedores
              </h2>
              <p className="text-xs text-gray-500">
                Evaluación de tiempos de entrega, confiabilidad y volúmenes de
                inversión.
              </p>
            </div>
              ...
              <div className="space-y-8">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[9px] text-gray-500 mt-0.5">
                        Proveedores con órdenes en el periodo.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <span className="text-xl font-black text-amber-600 font-mono">
                        $
                        {(reportData.inversion_total || 0).toLocaleString(
                          "en-US",
                          { minimumFractionDigits: 2 },
                        )}
                      </span>
                      <p className="text-[9px] text-gray-500 mt-0.5">
                        Capital total invertido en compras.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="p-4 bg-white/50 border-b border-gray-200 flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-bold text-gray-900">
                      Análisis Comparativo y Desempeño de Proveedores
                    </h3>
                  </div>
                      ...
                      <tbody className="divide-y divide-gray-200 font-mono text-gray-600">
                        {reportData.lista_proveedores.length === 0 ? (
                          ...
                          reportData.lista_proveedores.map((prov) => (
                            ...
                            >
                              <td className="p-3 pl-4 font-sans text-gray-900 font-semibold">
                                {prov.proveedor}
                              </td>
                              ...
                              <td className="p-3 text-center font-sans">
                                <span
                                  className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${prov.confiabilidad >= 85 ? "bg-emerald-100 text-emerald-800" : "bg-red-100 text-red-800"}`}
                                >
                                  {prov.confiabilidad}%
                                </span>
                              </td>
                ...
                <div className="download-btn-container pt-4 flex justify-end border-t border-gray-200">
                  ...
                  >
                    <Download size={14} />{" "}
                    {generandoPDF
                      ? "Generando PDF de Proveedores..."
                      : "Exportar Reporte de Proveedores (PDF)"}
                  </button>
                </div>
              </div>
            )
