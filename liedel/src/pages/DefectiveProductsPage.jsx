                ...
                filteredData.map((p, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-semibold ${estadoColor[p.estado_producto] || "bg-gray-100 text-gray-700"}`}
                      >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      {p.Tipo_resolucion ? (
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-semibold ${resolucionColor[p.Tipo_resolucion] || "bg-gray-100 text-gray-700"}`}
                        >
                          {resolucionLabel[p.Tipo_resolucion] ||
                            p.Tipo_resolucion}
                        </span>
                      ) : (
