      ...
      <main className="max-w-7xl mx-auto py-8 px-4 lg:px-8 space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 text-xs text-gray-500 mt-2">
                <span className="flex items-center gap-1">
                  ...
                  {cliente.Contacto_email || "N/A"}
                </span>
                <span className="flex items-center gap-1">
                  <Phone size={13} className="text-indigo-500" />{" "}
                  {cliente.Contacto_telefono || "N/A"}
                </span>
                <span className="flex items-center gap-1">
                  <MapPin size={13} className="text-indigo-500" />{" "}
                  {cliente.Ubicacion || "No especificada"}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-4 w-full md:w-auto overflow-x-auto">
            ...
            <div className="bg-gray-50 p-3 rounded-xl border border-gray-200 min-w-[130px]">
              ...
              <p className="text-base font-bold text-emerald-600 font-mono">
                $
                {Number(resumen.monto_total_gastado || 0).toLocaleString(
                  "en-US",
            ...
            <div className="bg-gray-50 p-3 rounded-xl border border-gray-200 min-w-[110px]">
              ...
              <p
                className={`text-base font-bold font-mono ${resumen.canceladas_cant > 0 ? "text-red-600" : "text-gray-900"}`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
            <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2 mb-4">
              <TrendingUp size={18} className="text-indigo-600" /> Histórico de
              Consumo por Mes
            </h3>
          ...
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
            <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2 mb-4">
              <Radio size={18} className="text-emerald-600" /> Gastos por Canal
              de Compra
            </h3>
            <div className="h-[200px]">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="p-4 bg-gray-50 border-b border-gray-200">
              <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2">
                <Building2 size={16} className="text-indigo-600" /> Sucursales
                Frecuentadas
              </h3>
            </div>
                ...
                <tbody className="divide-y divide-gray-100 font-mono text-gray-600">
                  {sucursales.length === 0 ? (
                    <tr>
                      <td
                        colSpan="3"
                        className="p-4 text-center font-sans text-gray-400"
                      >
                    ...
                    sucursales.map((s, idx) => (
                      <tr key={idx} className="hover:bg-gray-50">
                        ...
                        <td className="p-3 text-right font-bold text-emerald-600">
                          $
                          {Number(s.total_gastado).toLocaleString("en-US", {
                            minimumFractionDigits: 2,
                          })}
                        </td>
                      </tr>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="p-4 bg-gray-50 border-b border-gray-200">
              <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2">
                <Package size={16} className="text-indigo-600" /> Productos más
                Comprados
              </h3>
            </div>
            <div className="overflow-x-auto">
                  ...
                  {productos_comprados.length === 0 ? (
                    ...
                    productos_comprados.map((p, idx) => (
                      <tr key={idx} className="hover:bg-gray-50">
                        ...
                        <td className="p-3 text-right font-bold text-emerald-600">
                          $
                          {Number(p.total_invertido).toLocaleString("en-US", {
                            minimumFractionDigits: 2,
                          })}
                        </td>
                      </tr>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
          <div className="p-4 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
            <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2">
              <ShoppingBag size={16} className="text-indigo-600" /> Historial
              Detallado de Ventas
            </h3>
            <span className="text-xs text-gray-500 font-mono">
              {historial_compras.length} Registros
            </span>
          </div>
              ...
              <tbody className="divide-y divide-gray-100 font-mono text-gray-600">
                {historial_compras.length === 0 ? (
                  ...
                  historial_compras.map((venta) => {
                    const isCancelada = ["cancelada", "anulada"].includes(
                    ...
                    return (
                      <tr key={venta.Id_venta} className="hover:bg-gray-50">
                        ...
                        <td className="p-3 font-sans font-semibold text-gray-800">
                          {venta.canal}
                        </td>
                        <td className="p-3 font-sans">
                          <span
                            className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${
                              isCancelada
                                ? "bg-red-100 text-red-800 flex items-center gap-1 w-max"
                        ...
                        <td
                          className={`p-3 text-right font-bold ${isCancelada ? "line-through text-gray-400" : "text-gray-900"}`}
                        >
                          $
                          {Number(venta.monto || 0).toLocaleString("en-US", {
                            minimumFractionDigits: 2,
                          })}
                        </td>
                      </tr>
