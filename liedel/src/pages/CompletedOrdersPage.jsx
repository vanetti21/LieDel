					...
					<table className="min-w-full divide-y divide-gray-700">
						<thead>
							<tr>
								...
								<th className="px-6 py-3 text-left text-xs font-semibold text-black-600 uppercase tracking-wider">Delivered</th>
						...
						<tbody className="divide-y divide-gray-400">
							{filteredOrders.map((o, index) => (
								...
								>
									...
									<td className="px-6 py-4 text-green-500 whitespace-nowrap text-sm">
