...
const SalesPage = () => {
  ...
  const generatePDF = async () => {
    try {
      ...
      const chartTendenciaEl = document.querySelector(
        "#chart-tendencia-ventas",
      );
      const chartCanalesEl = document.querySelector("#chart-canales-venta");
      const chartVolumenEl = document.querySelector(
        "#chart-volumen-recaudacion",
      );
    ...
    <div className="flex-1 overflow-auto relative z-10">
      <main className="max-w-7xl mx-auto py-8 px-4 lg:px-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 text-gray-800 font-sans mb-8">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8 border border-gray-200 p-5 rounded-xl bg-[#f0f3f9]">
            <div>
              ...
              <p className="text-xs text-gray-500">
                Monitoreo de ingresos corrientes, volumen transaccional y
          ...
          {!reportData && !loadingReport && (
            ...
            >
              ...
              <p className="text-gray-600 font-medium">
                Establezca un rango de fechas en el panel superior para procesar
          ...
          {loadingReport && (
            <div
              className="text-center py-16 rounded-xl border border-gray-200"
              style={{ backgroundColor: "rgb(240, 243, 249)" }}
            >
              <div className="w-10 h-10 border-4 border-indigo-600 border-t-transparent rounded-full animate-spin mx-auto mb-4" />
              <p className="text-indigo-600 font-medium animate-pulse">
                Cruzando registros de facturación, clientes y sucursales...
              </p>
            </div>
          )}
          ...
          {reportData && (
            ...
            >
              ...
              <div
                className="p-4 rounded-xl border border-gray-200 text-xs text-gray-600 flex flex-nowrap items-center justify-between overflow-x-auto whitespace-nowrap"
                style={{ backgroundColor: "rgb(240, 243, 249)" }}
              >
                <div className="px-3">
                  INGRESOS NETOS:{" "}
                  <span className="text-green-600 font-bold">
                    $
                    {reportData.ingresos_totales?.toLocaleString("en-US", {
                ...
                <div className="px-3">
                  ...
                  <span className="text-indigo-600 font-bold">
                    $
                    {reportData.ticket_promedio?.toLocaleString("en-US", {
                      minimumFractionDigits: 2,
                    })}
                  </span>
                </div>
              ...
              >
                <h3 className="text-base font-bold mb-4 text-gray-900 flex items-center gap-2">
                  📈 Curva Temporal de Recaudación Diaria
                </h3>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                >
                  <div className="p-4 bg-white/50 border-b border-gray-200 flex items-center justify-between">
                    <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2">
                      <Users size={18} className="text-indigo-600" /> Cuota de
                      Facturación por Empleado
                    </h3>
                    <span className="text-xs text-gray-500 font-medium">
                      {reportData.ventas_empleados?.length || 0} Empleados
                    </span>
                  </div>
                    ...
                    <table className="w-full text-left text-xs text-gray-700">
                      ...
                      <tbody className="divide-y divide-gray-100 font-mono text-gray-600">
                        {reportData.ventas_empleados?.map((emp, idx) => {
                          const porcentaje =
                            reportData.ingresos_totales > 0
                              ? (
                                  (emp.total_facturado /
                                    reportData.ingresos_totales) *
                                  100
                                ).toFixed(1)
                              : 0;
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="p-3 text-right text-emerald-600 font-bold font-mono">
                                $
                                {emp.total_facturado?.toLocaleString("en-US", {
                                  minimumFractionDigits: 2,
                                })}
                              </td>
                            </tr>
                ...
                >
                  <div className="p-4 bg-white/50 border-b border-gray-200 flex items-center justify-between">
                    <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2">
                      <Tag size={18} className="text-amber-500" /> Rendimiento
                      por Categoría
                    </h3>
                    <span className="text-xs text-gray-500 font-medium">
                      {reportData.ventas_categorias?.length || 0} Categorías
                    </span>
                  </div>
                  <div className="overflow-y-auto max-h-[300px] bg-white">
                    <table className="w-full text-left text-xs text-gray-700">
                      ...
                      <tbody className="divide-y divide-gray-100 font-mono text-gray-600">
                        {reportData.ventas_categorias &&
                        reportData.ventas_categorias.length > 0 ? (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                >
                  <div className="p-4 bg-white/50 border-b border-gray-200 flex items-center justify-between">
                    <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2">
                      <UserCheck size={18} className="text-emerald-600" /> Top
                      10 Clientes con Mayor Facturación
                    </h3>
                    <span className="text-xs text-gray-500 font-medium">
                      {reportData.top_clientes?.length || 0} Clientes
                    </span>
                  </div>
                  <div className="overflow-x-auto bg-white">
                    <table className="w-full text-left text-xs text-gray-700">
                      ...
                      <tbody className="divide-y divide-gray-100 font-mono text-gray-600">
                        {reportData.top_clientes &&
                        reportData.top_clientes.length > 0 ? (
                          reportData.top_clientes.map((cli, idx) => (
                            ...
                            >
                              ...
                              <td className="p-3 text-center text-gray-700 font-semibold">
                                {cli.total_compras} ops.
                              </td>
                              <td className="p-3 text-right text-emerald-600 font-bold font-mono">
                                $
                                {cli.total_gastado?.toLocaleString("en-US", {
                                  minimumFractionDigits: 2,
                                  maximumFractionDigits: 2,
                                })}
                              </td>
                ...
                >
                  <div className="p-4 bg-white/50 border-b border-gray-200 flex items-center justify-between">
                    <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2">
                      <Package size={18} className="text-indigo-600" /> Top 10
                      Productos Más Vendidos
                    </h3>
                    <span className="text-xs text-gray-500 font-medium">
                      {reportData.top_productos?.length || 0} Productos
                    </span>
                  </div>
                  <div className="overflow-x-auto bg-white">
                    <table className="w-full text-left text-xs text-gray-700">
                      ...
                      <tbody className="divide-y divide-gray-100 font-mono text-gray-600">
                        ...
                        reportData.top_productos.length > 0 ? (
                          reportData.top_productos.map((prod, idx) => (
                            ...
                            >
                              ...
                              <td className="p-3 text-center text-indigo-600 font-bold">
                                {prod.unidades_vendidas} u.
                              </td>
                              <td className="p-3 text-right text-emerald-600 font-bold font-mono">
                                $
                                {prod.total_generado?.toLocaleString("en-US", {
                                  minimumFractionDigits: 2,
                                  maximumFractionDigits: 2,
                                })}
                              </td>
              ...
              <div
                className="rounded-xl border border-gray-200 p-5 overflow-hidden"
                style={{ backgroundColor: "rgb(240, 243, 249)" }}
              >
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2">
                    <Globe size={18} className="text-indigo-600" /> Distribución
                    por Canal de Venta
                  </h3>
                  <span className="text-xs text-gray-500 font-medium">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center bg-white p-4 rounded-xl border border-gray-200">
                  ...
                  <div id="chart-canales-venta" className="h-[200px] w-full">
                    {reportData.canales_venta &&
                    reportData.canales_venta.length > 0 ? (
                        ...
                        <PieChart>
                          ...
                          >
                            {reportData.canales_venta.map((entry, index) => (
                              <Cell
                                key={`cell-${index}`}
                                fill={COLORS_PAGO[index % COLORS_PAGO.length]}
                              />
                            ))}
                          </Pie>
                          <Tooltip
                            ...
                            <tr key={idx} className="hover:bg-gray-50">
                              <td className="p-2 font-sans font-semibold text-gray-900 flex items-center gap-2">
                                <span
                                  ...
                                  style={{
                                    backgroundColor:
                                      COLORS_PAGO[idx % COLORS_PAGO.length],
                                  }}
                                />
                                {c.canal}
                              </td>
                              ...
                              <td className="p-2 text-right font-bold text-gray-900">
                                $
                                {c.total_monto?.toLocaleString("en-US", {
                                  minimumFractionDigits: 2,
                                })}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                {/* GRÁFICA COMBINADA */}
                <div
                  id="chart-volumen-recaudacion"
                  className="lg:col-span-3 p-5 rounded-xl border border-gray-200"
                  style={{ backgroundColor: "rgb(240, 243, 249)" }}
                >
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div
                  className="xl:col-span-3 rounded-xl border border-gray-200 overflow-hidden"
                  style={{ backgroundColor: "rgb(240, 243, 249)" }}
                >
                  <div className="p-4 bg-white/50 border-b border-gray-200 flex items-center gap-2">
                    <DollarSign size={16} className="text-indigo-600" />
                    <h3 className="text-sm font-bold text-gray-900">
                      Registro de Transacciones de Mayor Volumen (Top 10)
                    </h3>
                  </div>
                  <div className="overflow-x-auto bg-white">
                    <table className="w-full text-left text-xs text-gray-700">
              ...
              <div className="download-btn-container pt-4 flex justify-end border-t border-gray-200">
                ...
                >
                  ...
                  {exportando
                    ...
                    : "Exportar Reporte de Ventas a PDF (Formato A4)"}
                </button>
              </div>
            </div>
          )}
