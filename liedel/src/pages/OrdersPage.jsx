    ...
    <div className="flex-1 overflow-auto relative z-10">
      <main className="max-w-7xl mx-auto py-8 px-4 lg:px-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 text-gray-800 font-sans mb-8">
          ...
          <div
            className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8 border border-gray-200 p-6 rounded-xl"
            style={{ backgroundColor: "rgb(240, 243, 249)" }}
          >
            <div>
              <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                Auditoría de Órdenes y Logística
              </h2>
              <p className="text-xs text-gray-500">
                Monitoreo de inversión en compras, métodos de envío y productos
                más demandados.
              </p>
            </div>
          ...
          {!reportData && !loadingReport && (
            ...
            >
              ...
              <p className="text-gray-600 font-medium">
                Establezca un rango de fechas para procesar las métricas de
                compras.
              </p>
            </div>
          )}
          ...
          {loadingReport && (
            ...
            >
              ...
              <p className="text-indigo-600 font-medium animate-pulse">
                Procesando registros de logística, proveedores y productos...
              </p>
            </div>
          )}
          ...
          {reportData && (
            ...
            >
              ...
              <div
                className="p-4 rounded-xl border border-gray-200 text-xs text-gray-600 flex flex-wrap gap-y-2 justify-between items-center divide-x divide-gray-200"
                style={{ backgroundColor: "rgb(240, 243, 249)" }}
              >
                <div className="px-4">
                  INVERSIÓN TOTAL:{" "}
              ...
              >
                <h3 className="text-base font-bold mb-4  text-gray-900 flex items-center gap-2">
                  ...
                  📈 Curva Temporal de Inversión en Compras
                </h3>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                >
                  <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2 mb-4">
                    <Navigation size={18} className="text-blue-600" /> Logística
                    y Tipos de Envío
                  </h3>

                  <div
                    id="chart-tipos-envio"
                    ...
                    <table className="w-full text-left text-xs text-gray-700">
                      ...
                      <tbody className="divide-y divide-gray-100 font-mono text-gray-600">
                        {reportData.productos_mas_ordenados?.length === 0 ? (
                          ...
                          reportData.productos_mas_ordenados?.map(
                            (prod, idx) => (
                              <tr
                                key={idx}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                >
                  <div className="p-4 bg-white/50 border-b border-gray-200 flex items-center justify-between">
                    <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2">
                      <Truck size={18} className="text-indigo-600" /> Inversión
                      por Proveedor (Top 10)
                    </h3>
                    <span className="text-xs text-gray-500 font-medium">
                      {reportData.ventas_proveedores?.length || 0} Proveedores
                    </span>
                  </div>
                ...
                <div
                  className="rounded-xl border border-gray-200 overflow-hidden p-4"
                  style={{ backgroundColor: "rgb(240, 243, 249)" }}
                >
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                            ...
                            paddingAngle={4}
                          >
                            {reportData.distribucion_estados?.map(
                              (entry, index) => (
                                <Cell
                                  key={`cell-${index}`}
                                  fill={
                                    COLORS_ESTADOS[
                                      index % COLORS_ESTADOS.length
                                    ]
                                  }
                                />
                              ),
              ...
              >
                <div className="p-4 bg-white/50 border-b border-gray-200 flex items-center justify-between">
                  <h3 className="text-sm font-bold text-gray-900 flex items-center gap-2">
                    <FileText size={16} className="text-indigo-600" /> Registro
                    de Órdenes Relevantes
                  </h3>
                  <span className="text-xs text-gray-500 font-medium">
                            ...
                            <span
                              className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${
                                ord.Estado?.toLowerCase() === "pendiente"
                                  ...
                                  : ["completada", "entregada"].includes(
                                        ord.Estado?.toLowerCase(),
                                      )
              ...
              <div className="download-btn-container pt-4 flex justify-end border-t border-gray-200">
                ...
                >
                  <Download size={14} />{" "}
                  {exportando
                    ? "Generando PDF de Órdenes..."
                    : "Exportar Reporte de Órdenes a PDF (Formato A4)"}
                </button>
              </div>
            </div>
          )}
