      ...
      <Page size="A4" style={styles.page}>
        ...
        {chartImages?.tendenciaVentas && (
          <View style={{ marginBottom: 10 }} wrap={false}>
            <Image
              ...
              src={chartImages.tendenciaVentas}
            />
          </View>
        )}
            ...
            <View style={styles.table}>
              ...
              {reportData?.ventas_categorias?.slice(0, 8).map((cat, idx) => (
                <View key={idx} style={styles.tableRow}>
                  ...
                  <Text style={{ width: "50%", textAlign: "right" }}>
                    $
                    {cat.total_facturado?.toLocaleString("en-US", {
                      minimumFractionDigits: 2,
                    })}
                  </Text>
                </View>
        ...
        {chartImages?.canalesVenta && (
          <View style={{ marginBottom: 10 }} wrap={false}>
            ...
            <View style={{ alignItems: "center", marginBottom: 8 }}>
              <Image
                style={{ width: "55%", height: 170, objectFit: "contain" }}
                src={chartImages.canalesVenta}
              />
            </View>
              ...
              {reportData?.canales_venta?.map((c, idx) => {
                const porcentaje =
                  reportData?.ingresos_totales > 0
                    ? (
                        (c.total_monto / reportData.ingresos_totales) *
                        100
                      ).toFixed(1)
                    : 0;
                return (
        ...
        {chartImages?.volumenVsRecaudacion && (
          <View style={{ marginBottom: 10 }} wrap={false}>
            <Image
              style={styles.fullWidthChartImage}
              src={chartImages.volumenVsRecaudacion}
            />
          </View>
        )}
