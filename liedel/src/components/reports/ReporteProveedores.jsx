      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>
            Dashboard de Analítica de Proveedores
          </Text>
        ...
        <View style={styles.kpiContainer}>
          ...
          <View style={styles.kpiBox}>
            ...
            <Text style={[styles.kpiValue, { color: "#D97706" }]}>
              $
              {(data?.inversion_total || 0).toLocaleString("en-US", {
        ...
        <View style={styles.table}>
          <View style={styles.tableHeader}>
            ...
            <Text style={{ width: "16%", textAlign: "center" }}>
              Demora Prom.
            </Text>
          ...
          {data?.lista_proveedores?.length > 0 ? (
            data.lista_proveedores.map((prov) => {
              ...
              return (
                ...
                >
                  ...
                  <Text
                    style={{ width: "16%", color: "#94A3B8", fontSize: 7.5 }}
                  >
            ...
            <View style={styles.tableRow}>
              <Text
                style={{ width: "100%", textAlign: "center", color: "#94A3B8" }}
              >
        ...
        {data?.ordenes_retrasadas?.length > 0 && (
          <View>
            ...
            <View style={styles.table}>
              <View
                style={[styles.tableHeader, { backgroundColor: "#FEF2F2" }]}
              >
              ...
              {data.ordenes_retrasadas.map((oc) => (
                <View
                  ...
                  wrap={false}
                >
                  <Text style={{ width: "15%", color: "#94A3B8" }}>
                    #{oc.Id_orden_compra}
                  </Text>
