      ...
      >
        <div>
          ...
          <p className="text-xs text-gray-500">
            Historial profundo de rotación, rentabilidad y reabastecimiento
            indexado por rango de fecha.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 bg-white p-2 rounded-xl shadow-sm border border-gray-200 w-full lg:w-auto">
          <div className="flex items-center gap-1 text-xs font-semibold text-gray-600 px-2 border-r border-gray-200">
            ...
            <input
              ...
              className="w-14 bg-gray-100 p-1 rounded font-mono text-center outline-none border border-gray-200"
            />
          </div>
      ...
      {loading && (
        ...
        >
          ...
          <p className="text-indigo-600 font-medium">
            Cruzando flujos de inventario, compras logísticas y facturas de
            venta...
          </p>
        </div>
      )}
      ...
      {data && !loading && (
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      data.historial_compras.map((cmp, idx) => (
                        <tr key={idx} className="hover:bg-gray-50">
                          ...
                          <td className="p-2 text-center pr-4 font-sans">
                            <span
                              className={`px-1.5 py-0.5 rounded text-[9px] font-bold ${cmp.Estado?.toLowerCase() === "completada" ? "bg-green-50 text-green-600 border border-green-200" : "bg-amber-50 text-amber-600 border border-amber-200"}`}
                            >
                              {cmp.Estado}
                            </span>
                          </td>
            ...
            <div
              className="rounded-xl border border-gray-200 overflow-hidden flex flex-col mt-6"
              style={{ backgroundColor: "rgb(240, 243, 249)" }}
            >
              <div className="p-3.5 bg-white/50 border-b border-gray-200 flex items-center gap-2">
                      ...
                      data.historial_precios.map((hp) => {
                        ...
                        return (
                          <tr key={hp.Id_precio} className="hover:bg-gray-50">
                            ...
                            <td
                              className={`p-2 text-center font-bold ${diferencia > 0 ? "text-green-600" : diferencia < 0 ? "text-red-600" : "text-gray-400"}`}
                            >
                              {diferencia > 0
