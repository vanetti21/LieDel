		...
		>
			...
			<div className='overflow-x-auto'>
				<table className='min-w-full divide-y divide-gray-700'>
					<thead>
						<tr>
							<th className='px-6 py-3 text-left text-xs font-medium text-black-100 uppercase tracking-wider'>
								Order ID
							</th>
							<th className='px-6 py-3 text-left text-xs font-medium text-black-100 uppercase tracking-wider'>
								Customer
					...
					<tbody className='divide divide-gray-700'>
						{filteredOrders.map((order) => (
							...
							>
								...
								<td className='px-6 py-4 whitespace-nowrap text-sm text-black-100'>{order.date}</td>
