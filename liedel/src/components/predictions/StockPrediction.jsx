				...
				<table className='min-w-full divide-y divide-gray-700'>
					<thead className='sticky top-0 bg-gray-100 z-10'>
						<tr>
							...
							<th className='px-6 py-3 text-left text-xs font-semibold text-black-600 uppercase tracking-wider'>Avg Sales</th>
							<th className='px-6 py-3 text-left text-xs font-semibold text-black-600 uppercase tracking-wider'>Days Left</th>
							<th className='px-6 py-3 text-left text-xs font-semibold text-black-600 uppercase tracking-wider'>Risk</th>
						</tr>
					</thead>
