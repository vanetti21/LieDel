        ...
        >
            ...
            <main className="flex-1 overflow-y-auto">
                <Routes>
                    ...
                    <Route path="/Employees"          element={<ProtectedRoute permission="Ver UsersPage"><EmployeesList /></ProtectedRoute>} />
					...
					<Route path="/clients/list"            element={<ProtectedRoute permission="Ver ClientsPage"><ClientsListPage /></ProtectedRoute>} />
					<Route path="/clients/detail/:id"            element={<ProtectedRoute permission="Ver ClientsPage"><ClientDetailPage /></ProtectedRoute>} />
					<Route path="/clients/vip"            element={<ProtectedRoute permission="Ver ClientsPage"><VipClientsPage /></ProtectedRoute>} />
					
					
					<Route path="/suppliers"          element={<ProtectedRoute permission="Ver SuppliersPage"><SuppliersPage /></ProtectedRoute>} />
					<Route path="/suppliers/list"     element={<ProtectedRoute permission="Ver SuppliersPage"><SuppliersListPage /></ProtectedRoute>} />
                    <Route path="/suppliers/detail/:id"     element={<ProtectedRoute permission="Ver SuppliersPage"><SupplierDetailPage /></ProtectedRoute>} />
                    ...
                    <Route path="/products/all"       element={<ProtectedRoute permission="Ver ProductsPage"><AllProductsPage /></ProtectedRoute>} />
					
					
					<Route path="/sales/list" element={<ProtectedRoute permission="Ver SalesPage"><SalesListPage /></ProtectedRoute>} />
					<Route path="/sales/:id" element={<ProtectedRoute permission="Ver SalesPage"><SalesDetailPage /></ProtectedRoute>} />
